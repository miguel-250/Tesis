...
\addcontentsline{toc}{section}{Introducción}
    ...
    \section{Internet de las Cosas en museos internacionales}\label{sec:iotMundo}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|lll|}
                \hline
                \multicolumn{3}{|c|}{Continuación Tabla \ref{tab:iotInternacional1}}                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
    ...
    Como se observa en la tabla \ref{tab:iotInternacional1} existen disímiles ejemplos de aplicación del Internet de las Cosas a nivel internacional; de ahí que se enfatizará en la aplicación de sistemas de conservación de las piezas en los museos tomando como referencia los ejemplos anteriormente expuestos.
    ...
    En la figura \ref{imag:modelos_arquitecturas_iot} se representa una comparativa de algunos modelos basados en capas.
    ...
    En la tabla \ref{tab: referencias_capas} se muestra la relación de las referencias correspondientes a la figura \ref{imag:modelos_arquitecturas_iot}
    ...
    La muestra Francisco Prat Puig está distribuida de tal modo que las piezas están ubicadas en tres salas expositivas. Enumerándolas: sala 1, sala 2 y sala 3.\\
    ...
    El nivel de salitre, como se muestra en la tabla, es obtenido mediante el análisis del nivel de humedad presente en los locales de la muestra.
