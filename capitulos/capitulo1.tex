...
\addcontentsline{toc}{section}{Introducción}
    ...
    En esta capa se encuentran los sensores que, de manera general recopilarán los datos para luego ser enviados a su procesamiento. La muestra Prat está distribuida de tal modo que las piezas están ubicadas en tres locales. En estos las piezas se ubican dispuestas dentro de vitrinas, de ahí la necesidad de incorporar nodos en cada una de estas y el control de la habitación en general.\\\\
    ...
    \begin{table}[h]
        ...
        Salitre                                                            & -          & Obtenida mediante análisis de nivel de humedad.                                                                                             \\ \hline
        Xilófagos                                                          & -          & \begin{tabular}[c]{@{}l@{}}Son controlados por cálculo de las posibles causas\\ que provocan su aparición.\end{tabular}                     \\ \hline
        \end{tabular}
    ...
    La medida del nivel de salitre, como se dice en la tabla \ref{tab:relacion_sensores}, es obtenida mediante el análisis del nivel de humedad presente en los locales de la muestra.\\

    ...

    Alimentación …\\

    Esquema de conexiones de un nodo (Revisar las conexiones de los sensores al NodeMcu).




    \subsection{Capa de transporte}
    Entre las tres salas que componen la muestra existe una separación considerable, por ello la necesidad de incorporar una comunicación inalámbrica. Este transporte de datos se realiza mediante ...
