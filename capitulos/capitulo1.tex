\chapter{Estado del arte} \label{cap:aproxTeoricas}
...
\addcontentsline{toc}{section}{Introducción}
    ...
    %\section{Sensores a emplear}\label{sec: sensoresEmplear}
