...
\addcontentsline{toc}{section}{Introducción}
    ...
    así como el empleo de comunicaciones Wifi y de RED en la capa de transporte y el concentrador RaspberryPi perteneciente a la capa de procesamiento donde se trabaja además, sobre la plataforma perteneciente al patrimonio universitario.
    ...
    Contiene todos los Nodos que se ubicarán en cada vitrina de la colección con sus sensores interconectados segun sea la necesidad de cada vitrina y permitirán obtener los valores de las variables ambientales.

    Esta sucesión de sensores, en conjunto con el microcontrolador conforman la capa de percepción (figura \ref{imag:capa_percepcion}). 
    ...
    \addcontentsline{toc}{subsection}{\hspace{1.3cm}1.3.2.1\hspace{5mm}Nodos}
    \textbf{1.3.2.1\hspace{5mm}Nodos}

    Los nodos que recopilarán los datos de cada vitrina estarán compuestos por el microcontrolador y los sensores encargados de tomar los valores medioambientales presentes teniendo en cuenta el material de las piezas expuestas dentro de cada una de las vitrinas por separado.\\

    \textbf{Tengo ideas de agregar la descripción de los sensores con el microcontrolador con respecto a las variables medioambientales pero creo que me choca con lo que debo poner en el capítulo I}
