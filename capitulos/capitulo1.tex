...
\addcontentsline{toc}{section}{Introducción}
    ...
    \section{Internet de las Cosas en museos internacionales}\label{sec:iotMundo}
        ...
        \begin{table}[h]
            \begin{tabular}{|lll|}
                \hline
                \multicolumn{3}{|c|}{Continuación Tabla 1.1}                                                                                                                                                                                                                                                                                                                                                                                                                                                    \\ \hline
                ...
                \multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}Sistema para la conservación\\ de las piezas en los museos\\ en base a pruebas\\ de contacto o movimiento,\\ intensidad de la luz.\end{tabular}} & \multicolumn{1}{l|}{Universidad de El Cairo, Egipto}                                                                                                                                                              & \begin{tabular}[c]{@{}l@{}}(Al-Habal\\ y Khattab, 2019).\end{tabular}    \\ \hline
