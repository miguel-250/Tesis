...
\addcontentsline{toc}{section}{Introducción}
    ...
    \addcontentsline{toc}{subsection}{\hspace{1.3cm}1.3.3.1\hspace{5mm}Nodos}
        \textbf{\large 1.3.3.1\hspace{5mm}Nodos}
    ...
    \addcontentsline{toc}{subsection}{\hspace{1.3cm}1.3.3.2\hspace{5mm}Composición nodos según ubicación}
        \textbf{\large 1.3.3.2\hspace{5mm}Composición nodos según ubicación}

    Ya que existe más de una ubicación para los nodos (ver tabla \ref{tab:correlacion_nodos}), dígase en vitrinas o ubicados en la habitación, vale mencionar que influye en la composición de dicho nodo.\\
    
    Esta composición viene dada 
    ...
    ...
    \addcontentsline{toc}{subsection}{\hspace{1.3cm}1.3.4.1\hspace{5mm}Protocolo MQTT}
        \textbf{\large 1.3.4.1\hspace{5mm}Protocolo MQTT}
    ...
    \addcontentsline{toc}{subsection}{\hspace{1.3cm}1.3.4.2\hspace{5mm}Protocolo HTTP}
        \textbf{\large 1.3.4.2\hspace{5mm}Protocolo HTTP}
    ...
    \addcontentsline{toc}{subsection}{\hspace{1.3cm}1.3.4.3\hspace{5mm}Protocolo TCP/IP}
        \textbf{\large 1.3.4.3\hspace{5mm}Protocolo TCP/IP}
