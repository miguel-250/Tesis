...
\addcontentsline{toc}{section}{Introducción}
    ...
    \begin{table}[H]
        ...
        Temperatura & 18 - 25°C            & \multirow{3}{*}{Vidrio y Cerámicos}          & \multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}\cite{buysConservationRestorationCeramics2014}\\ \cite{garciaherasInnovationGestionConservacion2015}\\ \cite{koobConservationRestorationGlass2004}\end{tabular}}                                                    \\ \cline{1-2}
        Humedad     & 40 - 65\%            &                                              &                                                                                                                                                                                                                                                                \\ \cline{1-2}
        Iluminación & 50 - 250 Lux         &                                              &                                                                                                                                                                                                                                                                \\ \hline
        CO2         & 400 - 600ppm         & Papel y Tela                                 & \cite{marquezAgentesDeterioroMedioambientales2016}                                                                                                                                                                                                             \\ \hline
        Temperatura & 10 - 25°C            & \multirow{2}{*}{Papel, Tela, Metal y Piedra} & \multirow{2}{*}{\cite{recioalvaroConservacionPreventivaExposiciones2020}}                                                                                                                                                                                      \\ \cline{1-2}
        Humedad     & 30 - 50\%            &                                              &                                                                                                                                                                                                                                                                \\ \hline
        \end{tabular}
    \end{table}
