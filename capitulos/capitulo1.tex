...
\addcontentsline{toc}{section}{Introducción}
    ...
    Analizar la estructura definitiva de la arquitectura IoT y diseñar la imágen.
    ...
    [Imagen de la sala 1]\newline
    En la sala 2 solamente se encuentran tres pinturas pertenecientes a la colección (ver imágen ... ), éstas poseen también condiciones de deterioro notables por el efecto de la humedad y del nivel de luz dentro del local. La humedad provoca la aparición de hongos en el lienzo deteriorándolo y dañando también el color.\newline
    [Imagen de la sala 2]\newline
    ...
    [Imagen sala 3]\newline
    En la siguiente gráfica se relaciona el valor cuantitativo de las principales formas en las que se exponen las piezas dentro de estas salas:\newline
    ...
    La medida del nivel de salitre, como se muestra en la tabla, es obtenida mediante el análisis del nivel de humedad presente en los locales de la muestra.\\
    …
    ...
    \subsection{Capa de comunicación}\label{subsec:capa_transporte}
    ...
    \subsection{Capa de actuación}\label{subsec:capa_aplicacion}
